A perl script to recognize the transmembrane domains of a protein. It is able to create a .txt file (out.txt) with the ID of a protein, the AC (responding to Uniprot) 
